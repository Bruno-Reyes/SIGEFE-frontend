...
import GenerarRutasDistribucion from '../components/Logistica/GenerarRutas'
...
const HomePage = () => {
  ...
  const renderContent = () => {
    switch (activeComponent) {
      ...
      case 'candidatos':
        return <Candidatos /> // Aceptacion de candidatos
      ...
      case 'generar_rutas_distribucion':
        return <GenerarRutasDistribucion />
