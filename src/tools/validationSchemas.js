...
export const Schemas = {
  ...
  peso: Yup.number().min(0, 'El peso no puede ser negativo').max(200, 'El peso no puede ser mayor a 200').required('El peso es obligatorio'),
  estatura: Yup.number().min(0, 'La estatura no puede ser negativa').max(300, 'La estatura no puede ser mayor a 300').required('La estatura es obligatoria'),
